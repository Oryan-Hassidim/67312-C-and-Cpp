...
tweets_file = "/cs/usr/oryan.hassidim/ex3b/ex3b-oryan.hassidim/justdoit_tweets.txt"
...
def get_dots():
    with open("/cs/usr/oryan.hassidim/ex3b/ex3b-oryan.hassidim/oh_tests/dots.txt", 'r') as f:
        content = f.read()
